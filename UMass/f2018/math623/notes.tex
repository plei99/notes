...
\chapter{Lebesgue Measure}% \label{cha:lebesgue_measure}

\section{Motivation for the Course}% \label{sec:introduction}
...
\section{Outer Measure}% \label{sec:outer_measure}
...
\section{Measurable Sets}% \label{sec:measurable_sets}
...
\section{Measurable Functions}% \label{sec:measurable_functions}
...
\section{Defining the Integral}% \label{sec:defining_the_integral}
...
\section{Some Convergence Results}% \label{sec:some_convergence_results}
...
\section{Bounded Variation}% \label{sec:bounded_variation}
...
\section{Absolute Continuity}% \label{sec:absolute_continuity}
...
\chapter{General Measures}% \label{cha:general_measures}
...
\section{Outer Measures}% \label{sec:outer_measures}
...
\section{Results and Applications}% \label{sec:results_and_applications}
...
\section{Signed Measures}% \label{sec:signed_measures}
