...
\begin{exm}
    ...
    \label{fig:sequence-holomorphic-bijections}
    \end{figure}
\end{exm}
...
\label{fig:branched-cover-sphere-by}
\end{figure}
...
\label{fig:pictoral-proof-alexander-numbering}
\end{figure}
...
\begin{exm}
    ...
    \label{fig:generalized-dirichlet-problem-upper}
    \end{figure}
...
\begin{exm}
    ...
    \label{fig:generalized-dirichlet-problem-first}
    \end{figure}
...
\begin{exm}
    ...
    \label{fig:generalized-dirichlet-problem-disk}
    \end{figure}
