...
\chapter{Quantum and complex integrable systems}
...
where $\wh{A}$ is the $\wh{A}$-genus. The term on the right should be viewed as the contribution of non-isolated components of the fixed locus and can be thought of as Fourier modes of infinitesimal loops.
