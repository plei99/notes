...
\begin{proof} Choose homotopy inverses $\alpha_-, \beta_-$. We need to
    ...
    $\Phi$. We will set $\Phi_i: Z(f') \times I \to Z(f)$ to be the space shown in~\Cref{fig:mcyl}.
    \begin{figure}[htpb]
    \begin{center}
...
\end{equation*} and looks something like~\Cref{fig:attachcell}.
\begin{figure}[htpb]
\begin{center}
...
be the standard orientation. For example, consider a single $2$-simplex as in~\Cref{fig:simporient}.
\begin{figure}[htpb]
\begin{center}
...
restrictions are clearly opposite to each other, as in~\Cref{fig:orientsimp}. 
\begin{figure}[htpb]
\begin{center}
