...
\section{Representable Functors}% \label{sec:representable_functors}
...
\section{Grothendieck Topologies}% \label{sec:grothendieck_topologies}
...
\section{Sheaves on Sites}% \label{sec:sheaves_on_sites}
...
\section{Sieves}% \label{sec:sieves}
...
\section{Fibered Categories}% \label{sec:fibered_categories}
...
\section{Flat Morphisms}% \label{sec:flat_morphisms}
...
\section{\'Etale morphisms}% \label{sec:'etale_morphisms}
...
\section{\'Etale fundamental group}% \label{sec:'etale_fundamental_group}
...
\section{Universal Cover}% \label{sec:universal_cover}
...
\section{Toproll Basics}% \label{sec:toproll_basics}
...
\section{Review of Fibered Categories}% \label{sec:more_on_fibered_categories}
...
\section{$2$-Yoneda Lemma}% \label{sec:_2_yoneda_lemma}
...
\section{Pursuing Stacks}% \label{sec:pursuing_stacks}
...
\section{Divisors and Picard Groups}% \label{sec:divisors_and_picard_groups}
...
\section{Jacobian Functor}% \label{sec:jacobian_functor}
...
\section{Shoulder Press}% \label{sec:shoulder_press}
...
\section{History of Armwrestling}% \label{sec:history_of_armwrestling}
