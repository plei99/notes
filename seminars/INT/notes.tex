...
\end{scriptsize}
\end{tikzpicture}
\caption{Five points in general position determine a unique conic.}%
\label{fig:five-points-conic}
\end{figure}
...
\end{scriptsize}
\end{tikzpicture}
\caption{Projection from $P_0$ to the line $M$.}%
\label{fig:projection-to-line}
\end{figure}
...
\label{fig:weight-motivic-cohomology}
\end{figure}
