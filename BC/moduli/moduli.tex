...
\section{Existence of coarse moduli spaces}%
\label{sec:Existence of coarse moduli spaces}
...
\begin{proof}
    Suppose that $\pi X \to Y$ is a good quotient and $\phi \colon X \to Z$ is $G$-invariant. We will construct a morphism $g \colon Y \to Z$ filling in the dashed arrow in
    \begin{equation*}
    \begin{tikzcd}
