...
\begin{exm}
    In the case of $\sl_3$, the root system is drawn in~\Cref{fig:sl3-roots}.
    \begin{figure}[htpb]
    \begin{center}
    ...
    \def\wlen{0.577}
    \draw[->, blue, thick] (0,0) -- (30:\wlen) node[right] {$\omega_1$};
    \draw[->, blue, thick] (0,0) -- (90:\wlen) node[above] {$\omega_2$};
    ...
    \draw[->, thick] (0,0) -- (60:\rlen) node[above right] {$\alpha_1+\alpha_2$};
    
    % Negative roots
    \draw[->, thick] (0,0) -- (180:\rlen) node[left] {$-\alpha_1$};
    \draw[->, thick] (0,0) -- (240:\rlen) node[below left] {$-\alpha_1-\alpha_2$};
    \draw[->, thick] (0,0) -- (300:\rlen) node[below right] {$-\alpha_2$};

    % Simple Roots (Highlighted)
    \draw[->, very thick, red] (0,0) -- (0:\rlen) node[right] {$\alpha_1$};
    \draw[->, very thick, red] (0,0) -- (120:\rlen) node[above left] {$\alpha_2$};
