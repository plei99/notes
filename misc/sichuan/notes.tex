...
\begin{abstract}
    These are live-TeXed (for all talks besides my own, some figures were inserted later using Codex or Claude Code) notes from the log GLSM summer school at Sichuan University in July 2026. Note that all talks besides mine were given in Chinese. I apologize for any translation errors as well as for any errors in my lectures.
\end{abstract}
