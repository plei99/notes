...
\begin{abstract}
    These are notes the log GLSM summer school at Sichuan University in July 2026.
\end{abstract}
...
\begin{exm}
    ...
    \[ M_X = \ab\{ \varphi \cdot t^n \mid \varphi \in \mc{O}_X^{\times} \} \cong \mc{O}_X^{\times} \oplus \N_{|0}. \]
\end{exm}
...
\[ QG(\P^4, d) \ab\{ [f_0, \ldots, f_4] \mid f_i \in \C[u,v], \deg f_i = d, (f_0, \ldots, f_4) \neq (0, \ldots, 0) \} \cong \P^{5d+5-1} \]
